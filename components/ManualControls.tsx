...
import { SpeedIcon, InclineIcon, PlayIcon, StopIcon } from './Icons';
...
export const ManualControls: React.FC<ManualControlsProps> = ({ onSetSpeed, onSetIncline, onStart, onStop, disabled }) => {
      ...
      <div className={`p-4 rounded-lg space-y-3 ${disabled ? 'opacity-50' : ''}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button onClick={() => handleSpeedChange(-0.1)} disabled={controlsDisabled} className={buttonClass}>-</button>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button onClick={() => handleInclineChange(-0.5)} disabled={controlsDisabled} className={buttonClass}>-</button>
