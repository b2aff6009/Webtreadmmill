...
export const PlugDisconnectedIcon: React.FC<IconProps> = (props) => (
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8h-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4H2v6a6 6 0 0 0 6 6h4c.73 0 1.43-.12 2.08-.34"/><path d="M21.7 16.2a2.4 2.4 0 0 0-3.4 0l-1.8 1.8a2.4 2.4 0 0 0 0 3.4l1.8 1.8a2.4 2.4 0 0 0 3.4 0l1.8-1.8a2.4 2.4 0 0 0 0-3.4Z"/>
 </svg>
);
